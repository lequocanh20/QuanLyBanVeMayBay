...
namespace GUI
{
    public partial class BanVeCB : Form
    {
        public BanVeCB()
        {
            InitializeComponent();
        ...
        private void VeCB_Load(object sender, EventArgs e)
        {
            xemdulieu();
        }

        private void VeCB_FormClosing(object sender, FormClosingEventArgs e)
        {
            Main main = new Main();
            this.Hide();
            main.Show();
        ...
        private void btnXemHanhKhach_Click(object sender, EventArgs e)
        {
